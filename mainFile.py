...
credentials = connectToTwitter.connect() #Done
leaderNames = getLeaderNames.getNames() #Done
getTweets.getTweets(credentials, leaderNames, db) #Done
getRetweeters.getRetweeters(credentials, leaderNames, databseLocation)
